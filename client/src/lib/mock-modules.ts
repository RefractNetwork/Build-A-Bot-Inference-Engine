    ...
    memory: [
        {
            ...
            data: [
                ...
                },
                {
                    ...
                    response:
                        "I appreciate all colors, but I find blue particularly fascinating!",
                },
            ],
        },
        {
            ...
            data: [
                {
                    ...
                    response:
                        "I can guide you through the password reset process. First, click on 'Forgot Password'...",
                },
                {
                    user: "My account is locked",
                    response:
                        "I understand this can be frustrating. Let's verify your identity first...",
                },
            ],
        },
    ],
