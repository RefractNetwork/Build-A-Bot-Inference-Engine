...
export function MarketplaceModuleCard({
    ...
    const handleListForSale = () => {
        ...
        // If the purchase function returns an object,
        // ensure you either use it or drop it. For a listing,
        // "update_module_marketplace_listing" may not return a new object,
        // so just the moveCall might work as is:
        tx.moveCall({
    ...
    const handlePurchase = async () => {
        ...
        // Split if the coin has more balance than needed
        if (totalBalance > BigInt(module.price)) {
        ...
        // The purchase function may return an object, so capture it
        ...
        // If purchase_module returns an object that needs to be owned,
        // transfer it to the buyer to avoid "UnusedValueWithoutDrop" errors:
